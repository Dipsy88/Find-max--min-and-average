...
//	private static String[] econsequenceG = {"0", "25", "50", "75", "100"};
	...
	public static void readFile() throws Exception{		
		...
		int count=0;
		try {
		    BufferedReader in = new BufferedReader(new FileReader("C:\\Experiments\\files\\test_1.txt"));
		    String str;
...
//		    		break;
		    	...
		    	if (details[0].contains("It") || details[0].contains("Iteration") ){
	...
	public static void createFile() throws Exception{
		fileName = new File("C:\\Experiments\\files\\avg\\avg1.txt");
