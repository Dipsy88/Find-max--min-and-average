...
public class FindAvgForOptimization {
...
//	private static String[] econsequenceG = {"0", "25", "50", "75", "100"};
	...
	public static void readFile() throws Exception{		
		...
		int count=0;
		try {
		    BufferedReader in = new BufferedReader(new FileReader("C:\\Experiments\\files\\RS\\test_2.txt"));
		    String str;
...
//		    		break;
	...
	public static void createFile() throws Exception{
		fileName = new File("C:\\Experiments\\files\\RS\\avg\\avg2_1.txt");
	...
	public static void createFile2() throws Exception{
		fileName2 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_2.txt");
	...
	public static void createFile3() throws Exception{
		fileName3 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_3.txt");
	...
	public static void createFile4() throws Exception{
		fileName4 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_4.txt");
	...
	public static void createFile5() throws Exception{
		fileName5 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_5.txt");
	...
	public static void createFile6() throws Exception{
		fileName6 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_6.txt");
	...
	public static void createFile7() throws Exception{
		fileName7 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_7.txt");
	...
	public static void createFile8() throws Exception{
		fileName8 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_8.txt");
	...
	public static void createFile9() throws Exception{
		fileName9 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_9.txt");
	...
	public static void createFile10() throws Exception{
		fileName10 = new File("C:\\Experiments\\files\\RS\\avg\\avg2_10.txt");
