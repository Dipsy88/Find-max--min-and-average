...
//	private static String[] econsequenceG = {"0", "25", "50", "75", "100"};
	...
	public static void readFile() throws Exception{		
		...
		int count=0;
		try {
		    BufferedReader in = new BufferedReader(new FileReader("C:\\Personal\\practice\\files\\test38.txt"));
		    String str;
...
//		    		break;
				...
				file.write(f.format(avg) + "\t" + "\t" + "\t" + "\t" + "\t" + "\t"); 
				file.write(f.format(max) + "\r"); 
				file.flush();
	...
	public static void createFile() throws Exception{
		fileName = new File("C:\\Personal\\practice\\files\\total38.txt");
	...
	public static void createFile2() throws Exception{
		fileName2= new File("C:\\Personal\\practice\\files\\totalAlgo38.txt");
